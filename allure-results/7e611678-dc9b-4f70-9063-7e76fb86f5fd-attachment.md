...
- main:
  ...
  - paragraph: "Actualizado: 08/09/2026, 16:56"
...
> 23 |     await expect (page.getByRole('link', { name: 'Cobranzas' })).toBeEnabled()
     |                                                                  ^ Error: expect(locator).toBeEnabled() failed
  24 |     await expect (page.getByRole('button', { name: 'Finanzas' })).toBeEnabled()
  25 |     await expect (page.getByRole('button', { name: 'Configuración' })).toBeEnabled()
  26 |     await expect (page.getByText('Gestión de Proveedores', { exact: true })).toBeEnabled()
  27 |   })
  28 | 
